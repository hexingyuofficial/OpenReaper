...
execFileSync(process.execPath, ["--test", "tests/layer4dx/first-real-a3-layer-report-route.test.mjs"], {
  cwd: root,
  stdio: "inherit",
});

execFileSync(process.execPath, ["--test", "tests/layer4dx/safe-write-a-handler-expansion.test.mjs"], {
  cwd: root,
  stdio: "inherit",
});

...
const allowlists = {
  ...
  "layer4.5a": [
    "docs/abi/ARTIFACT_STATE_STORE_V1.md",
    "package.json",
    "scripts/check-artifact-state-store.mjs",
    "scripts/check-layer-scope.mjs",
    "packages/core/src/artifact-state-store-v1.mjs",
    "tests/layer4_5a/**",
  ],
  "layer4.5b": [
    "docs/abi/ARTIFACT_STATE_STORE_V1.md",
    ...
    "scripts/check-layer-scope.mjs",
    "packages/core/src/artifact-state-store-v1.mjs",
    "packages/mcp-server/src/get-state-runtime-v1.mjs",
    "tests/layer4_5b/**",
  ],
  "layer4.5c": [
    "docs/LAYER_PROGRESS.md",
    ...
    "scripts/check-artifact-state-store.mjs",
    "scripts/check-layer-scope.mjs",
    "scripts/smoke-artifact-state-live.mjs",
    "packages/core/src/artifact-state-store-v1.mjs",
    "packages/core/src/artifact-state-store-live-helper-v1.mjs",
    "packages/mcp-server/src/get-state-runtime-v1.mjs",
    "packages/mcp-server/src/live-bridge-executor-v1.mjs",
    "reaper/bridge/openreaper-artifact-state-helper.lua",
    "tests/layer4_5c/**",
  ],
  layer5: [

...
export const ALPHA4_SHARD_C_SELECTOR_FAILURE_FIXTURES = Object.freeze([
  ...
  { id: "predicate-name-batch", kind: "predicate", input: { kind: "predicate", entity_kind: "track", field: "name", operator: "equals", value: "VOX" }, expected: { code: "SELECTOR_TARGETS_BATCHED", writes: 2, undo_opened: true } },

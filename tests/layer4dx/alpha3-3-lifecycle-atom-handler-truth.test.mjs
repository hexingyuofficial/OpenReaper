...
describe("Alpha3.3 exact lifecycle atom handler truth", () => {
  it("registers exactly eight extracted native handlers and assembles their dispatch routes", () => {
    ...
    assert.equal(summary.entryCount, 241);
    assert.equal(summary.extractedHandlerCount, 241);
...
`);
  ...
  it("keeps public catalog and live-handler counts equal to the actual 241-row catalog and registry", () => {

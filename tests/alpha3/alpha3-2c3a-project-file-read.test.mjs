...
describe("Alpha3.2-C3A current project path and dirty-state reads", () => {
  ...
  it("keeps historical Alpha2 evidence at 215 while carrying the 242-id current product", () => {
    ...
    assert.equal(current.live_gate.allowed_template_ids.length, 242);

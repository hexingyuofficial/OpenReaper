...
describe("Layer 4D.2 REAPER-side live bridge script", () => {
  it("bundles the manual bridge from stable source modules without changing the output", () => {
    ...
    assert.doesNotMatch(sourceModules["40-route-pack-handlers.lua"], /template_count = 129/);
  ...
  it("keeps the approved Wave 0, Wave 1A, Read-B, E3 media, E5-R1 routing read, and E2-FX-L1 read query operations exact", () => {

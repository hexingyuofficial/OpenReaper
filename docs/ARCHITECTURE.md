...
| V1 had six Layer 7 draft/fake-smoked recipe candidates; Alpha2 has twelve first-atoms draft recipes; Alpha3 has fifteen with fast observation, project-map snapshot, and recording-track starter cards. | Official recipe checks and Alpha2/Alpha3 closure records. |

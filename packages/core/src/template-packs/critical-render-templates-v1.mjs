  ...
  },
  {
    ...
    expectedDelta: {
      ...
      entities: [
        ...
        { entity_kind: "output_file", action: "create", summary: "Managed WAV, OGG, or MP3 files are created only after all expected outputs preflight cleanly." },
    ...
    verification: requiredVerification([
      ...
      check("output_files_verified", "file_metadata", "Every output exists, is non-empty, and has the expected WAV, OGG, or MPEG Layer III header."),
    ...
    examples: [
      ...
      {
        name: "render_whole_project_mp3",
        summary: "Render the whole project once to a managed 320 kbps MP3 output.",
        input: { target_kind: "whole_project", format: "mp3", output_policy: "openreaper_managed_render_root", collision_policy: "fail_if_exists", sample_rate_hz: 48000, channel_count: 2, mp3_bitrate_kbps: 320, max_targets: 1 },
      },
    ],
  },
  renderJobDescriptor({

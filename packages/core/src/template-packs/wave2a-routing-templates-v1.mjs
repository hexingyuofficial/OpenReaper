...
export const WAVE2A_ROUTING_TEMPLATES = deepFreeze([
  ...
  },
  {
    ...
    inputSchema: objectSchema({
      ...
      edge_cursor: { type: "integer" },
      include_tracks: { type: "boolean" },
      include_master_parent: { type: "boolean" },
      resolve_track_refs: { type: "array", maxItems: 128, items: { type: "string" } },
      state_track_refs: { type: "array", maxItems: 128, items: { type: "string" } },
    }, []),
    outputSchema: objectSchema({
      track_count: { type: "integer" },
      scanned_track_count: { type: "integer" },
      edge_count: { type: "integer" },
      total_edge_count: { type: "integer" },
      returned_edge_count: { type: "integer" },
      edge_cursor: { type: "integer" },
      next_edge_cursor: { type: "string" },
      tracks: { type: "array" },
      edges: { type: "array" },
      truncated: { type: "boolean" },
    }, []),

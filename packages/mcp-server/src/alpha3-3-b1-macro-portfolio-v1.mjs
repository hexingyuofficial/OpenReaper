...
export function canonicalizeAlpha3_3B1MacroDiscoveryItem(item, canonicalId) {
  ...
  if (canonicalId === "macro.midi.apply") {
    ...
    canonical.summary = "Set FX controls via proven stock semantic mappings, strict ReaEQ bands, one-FX exact_parameters, or multi-FX exact_assignments with complete inventory and live readback.";

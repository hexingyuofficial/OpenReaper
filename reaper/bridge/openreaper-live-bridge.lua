...
-- Handler registry: reaper/bridge/registry/BRIDGE_HANDLER_REGISTRY_V1.json (222 registered template handler row(s); 0 legacy_monolith row(s); 222 extracted handler row(s); 84 handler module file(s)).
...
-- OpenReaper bridge handler module: reaper/bridge/src/handlers/project/save_project_file.lua
__openreaper_register_handler_module("project/save_project_file.lua", function()
...
return {
  exports = { save_current_project = save_current_project, save_project_as = save_project_as },
  shared = {  },
}
end)
...
-- OpenReaper bridge handler module: reaper/bridge/src/handlers/items/set_active_take.lua
__openreaper_register_handler_module("items/set_active_take.lua", function()
...
return {
  exports = { set_active_take = set_active_take },
  shared = {  },
}
end)
...
-- OpenReaper bridge handler module: reaper/bridge/src/handlers/render/d29_render_output_policy_route.lua
__openreaper_register_handler_module("render/d29_render_output_policy_route.lua", function()
...
-- OpenReaper bridge handler module: reaper/bridge/src/handlers/render/d31_render_targets_route.lua
__openreaper_register_handler_module("render/d31_render_targets_route.lua", function()
...
local function read_track_item_overview(...)
  return OPENREAPER_HANDLER_EXPORTS.read_track_item_overview(...)
end
local function read_transport_state(...)
  return OPENREAPER_HANDLER_EXPORTS.read_transport_state(...)
end
...
return {
  exports = { create_cleanup_report = create_cleanup_report, create_project_map_snapshot = create_project_map_snapshot, create_observation_bundle = create_observation_bundle },
  shared = {  },
}
end)
...
local E5_AUTOMATION_WRITE_HANDLERS = {
  ...
  ["automation.delete_envelope_points"] = OPENREAPER_HANDLER_EXPORTS.delete_envelope_points,
...
local D29_RENDER_SETTINGS_WRITE_HANDLERS = {
  ["render.format.set"] = OPENREAPER_HANDLER_EXPORTS.set_render_format,
  ["render.ogg_quality.set"] = OPENREAPER_HANDLER_EXPORTS.set_ogg_quality_or_compression,
  ["render.mp3_bitrate_kbps.set"] = OPENREAPER_HANDLER_EXPORTS.set_mp3_bitrate_or_quality,
  ["render.flac_compression.set"] = OPENREAPER_HANDLER_EXPORTS.set_flac_compression,
...
local ALPHA3_2C3BC_PROJECT_FILE_SAVE_HANDLERS = {
  ["project.save_current_project"] = OPENREAPER_HANDLER_EXPORTS.save_current_project,
...
local ALLOWED_OPERATIONS = {
  ...
  ["run_command:render.format.set"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.set_render_format,
  },
  ["run_command:render.ogg_quality.set"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.set_ogg_quality_or_compression,
  },
  ["run_command:render.mp3_bitrate_kbps.set"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.set_mp3_bitrate_or_quality,
  },
  ["run_command:render.flac_compression.set"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.set_flac_compression,
  },
  ["run_command:render.aiff_bit_depth.set"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.set_aiff_bit_depth,
  },
  ["artifact_metadata:render.output.absolute_path"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.output_absolute_path,
  },
  ["artifact_metadata:render.output_file.metadata"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.output_file_metadata,
  },
  ...
  ["query_state:automation.project_envelopes.list"] = {
    pack = "automation",
    handler = OPENREAPER_HANDLER_EXPORTS.list_project_envelopes,
  },
  ...
  ["run_job:project.create_project_map_snapshot"] = {
    pack = "project",
    handler = OPENREAPER_HANDLER_EXPORTS.create_project_map_snapshot,
  },
  ["run_job:project.create_observation_bundle"] = {
    pack = "project",
    handler = OPENREAPER_HANDLER_EXPORTS.create_observation_bundle,
  },
  ...
  ["run_job:render.item"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.render_item,
  },
  ["run_job:render.selected_item"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.render_selected_item,
  },
  ["run_job:render.track_item"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.render_track_item,
  },
  ["run_job:render.selected_tracks"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.render_selected_tracks,
  },
  ["run_job:render.ogg"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.render_ogg,
  },
  ["run_job:render.mp3"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.render_mp3,
  },
  ["run_job:render.flac"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.render_flac,
  },
  ["run_job:render.aiff"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.render_aiff,
  },
  ["run_job:render.m4a"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.render_m4a,
  },
  ["run_job:render.opus"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.render_opus,
  },
  ["run_job:render.region_track_filter"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.render_region_with_track_filter,
  },
  ["run_job:render.targets"] = {
    pack = "render",
    handler = OPENREAPER_HANDLER_EXPORTS.d31_render_targets,
  },

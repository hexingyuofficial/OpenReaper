...
-- Handler registry: reaper/bridge/registry/BRIDGE_HANDLER_REGISTRY_V1.json (155 registered template handler row(s); 0 legacy_monolith row(s); 155 extracted handler row(s); 73 handler module file(s)).

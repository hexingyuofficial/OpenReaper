...
-- Handler registry: reaper/bridge/registry/BRIDGE_HANDLER_REGISTRY_V1.json (182 registered template handler row(s); 0 legacy_monolith row(s); 182 extracted handler row(s); 77 handler module file(s)).

...
-- Handler registry: reaper/bridge/registry/BRIDGE_HANDLER_REGISTRY_V1.json (60 registered template handler row(s); 55 legacy_monolith row(s); 5 extracted handler row(s); 5 handler module file(s)).

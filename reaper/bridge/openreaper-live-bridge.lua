...
-- Handler registry: reaper/bridge/registry/BRIDGE_HANDLER_REGISTRY_V1.json (214 registered template handler row(s); 0 legacy_monolith row(s); 214 extracted handler row(s); 80 handler module file(s)).
...
return {
  exports = { create_cleanup_report = create_cleanup_report, create_project_map_snapshot = create_project_map_snapshot },
  shared = {  },
}
end)

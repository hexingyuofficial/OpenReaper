...
-- Handler registry: reaper/bridge/registry/BRIDGE_HANDLER_REGISTRY_V1.json (165 registered template handler row(s); 0 legacy_monolith row(s); 165 extracted handler row(s); 75 handler module file(s)).

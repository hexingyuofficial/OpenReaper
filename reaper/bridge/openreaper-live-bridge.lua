...
-- Handler registry: reaper/bridge/registry/BRIDGE_HANDLER_REGISTRY_V1.json (186 registered template handler row(s); 0 legacy_monolith row(s); 186 extracted handler row(s); 78 handler module file(s)).
...
return {
  exports = { d20_project_set_grid = d20_project_set_grid },
  shared = {  },
}
end)

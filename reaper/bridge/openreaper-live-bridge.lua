...
-- Handler registry: reaper/bridge/registry/BRIDGE_HANDLER_REGISTRY_V1.json (148 registered template handler row(s); 0 legacy_monolith row(s); 148 extracted handler row(s); 72 handler module file(s)).

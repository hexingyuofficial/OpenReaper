...
-- Handler registry: reaper/bridge/registry/BRIDGE_HANDLER_REGISTRY_V1.json (70 registered template handler row(s); 0 legacy_monolith row(s); 70 extracted handler row(s); 63 handler module file(s)).

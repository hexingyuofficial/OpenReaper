...
-- Handler registry: reaper/bridge/registry/BRIDGE_HANDLER_REGISTRY_V1.json (219 registered template handler row(s); 0 legacy_monolith row(s); 219 extracted handler row(s); 82 handler module file(s)).
